      ...
      <div className="container mx-auto min-h-[800px] mb-14">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="mb-4 lg:mb-0 flex gap-x-2 text-sm">
            ...
            <div className="bg-violet-600 text-white px-3 rounded-full">
              {house?.country}
            </div>
          </div>
        ...
        <div className="flex flex-col items-start gap-8 lg:flex-row">
          ...
          <div className="flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg px-6 py-8">
            <div className="flex items-center gap-x-4 mb-8">
              <div className="w-20 h-20 border-gray-300 rounded-full p-1 border">
            ...
            <form className="flex flex-col gap-y-4">
              ...
              <textarea
                ...
                placeholder="Message"
                defaultValue="Hello i am interested in [Modern apartmant]"
              ></textarea>
              <div className="flex gap-x-2">
                <button className="bg-violet-700 hover:bg-violet-800 text-white rounded p-4 text-sm w-full transition">
                  Send message
                </button>
                <button className="border border-violet-700 text-violet-700 hover:bg-violet-500 hover:text-violet-5 rounded p-4 text-sm w-full transition">
                  Call
                </button>
              </div>
            </form>
